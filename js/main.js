...
const app = (() => {
      ...
      .then(_ => {
        swRegistration.pushManager.getSubscription()
          .then(subscription => {
            ...
            displayEndpointInformation(subscription)
  ...
  function getPublicKey() {
    return fetch('/vapid/publicKey').then(r => r.text()).then(p => applicationServerPublicKey = p)
  }
  ...
  function unsubscribeUser() {
    swRegistration.pushManager.getSubscription()
      ...
      .then(() => {
        displayEndpointInformation(null)
  ...
  function displayEndpointInformation(subscription) {
